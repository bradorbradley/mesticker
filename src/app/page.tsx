                ...
                <>
                  {!isGenerating ? (
                    <Button
                      ...
                      className="w-full h-14 btn-primary modern-button text-base font-semibold transition-all duration-300 transform hover:scale-105 rounded-2xl cartoon-button"
                    >
