      ...
      <div className="relative w-full h-[220px] flex items-center justify-center">
        ...
        {[-1, 1].map((offset) => {
          ...
          return (
            <div
              key={`bg-${offset}`}
              className="absolute w-[200px] h-[200px] rounded-2xl overflow-hidden shadow-soft"
              style={{
                transform: `translateX(${offset * 18}px) scale(0.9) rotate(${offset * 3}deg)`,
                zIndex: 0,
                opacity: 0.4,
              }}
            >
        ...
        <motion.div
          key={currentIndex}
          className={cn(
            "absolute w-[220px] h-[220px] rounded-2xl overflow-hidden cursor-grab active:cursor-grabbing z-10",
